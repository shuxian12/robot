...
class Tile(pygame.sprite.Sprite):
    def __init__(self, filename, x, y):
        ...
        self.original_image = pygame.image.load('images/hololive/vtuber/' + filename)
        self.back_image = pygame.image.load('images/hololive/background.png')
...
class Game():
    def __init__(self):
        ...
        # vtubers
        self.all_vtubers = [f for f in os.listdir('images/hololive/vtuber') if os.path.join('images/hololive/vtuber', f) if f.endswith('.png')]
        ...
        # load music
        pygame.mixer.music.load('sounds/アイドル.mp3')
        pygame.mixer.music.set_volume(.3)
        pygame.mixer.music.play()

        # initialize timer
        self.time_limit = 80.0
        self.timer = pygame.time.get_ticks()
        self.timer_font = pygame.font.Font('fonts/Comic Sans MS Bold.ttf', 24)
        ...
        self.game_win_img = pygame.image.load('images/game_win.gif').convert_alpha()
    ...
    def game_is_over(self):
        ...
        self.game_over_img = pygame.image.load('images/game_over.jpg').convert_alpha()
