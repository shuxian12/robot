...
def gamble(return_list):
    ...
    bg = pygame.transform.scale(pygame.image.load('../gamble/骰子/view.png'),(800,600))
    dice = []
    for i in range(6):
        dice.append(pygame.transform.scale(pygame.image.load(f'../gamble/骰子/{i+1}.jpg'),(40,40)))
    ...
    # 載入圖像
    screw = pygame.transform.scale(pygame.image.load('../gamble/骰子/screw.png'),(38,38))
    ...
    while True:
        ...
        window.blit(bg,(0,0))
        window.blit(pygame.transform.scale(pygame.image.load(f'../gamble/骰子/check.png'),(249,51)),(550,503))
        window.blit(pygame.transform.scale(pygame.image.load(f'../gamble/骰子/clear.png'),(198,51)),(351,503))
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if x>=550 and x<=799 and y>=503 and y<=554:
                    for i in range(16):
                        ...
                        window.blit(pygame.transform.scale(pygame.image.load(f'../gamble/骰子/check.png'),(249,51)),(550,503))
                        window.blit(pygame.transform.scale(pygame.image.load(f'../gamble/骰子/clear.png'),(198,51)),(351,503))
                        window.blit(pygame.transform.scale(pygame.image.load(f'../gamble/骰子/row{i%4+1}.png'),(334,208)),(230,0))
                        pygame.draw.rect(window,(0,150,0),pygame.Rect(145,97,75,77))
                        pygame.draw.rect(window,(0,75,0),pygame.Rect(0,496,347,70))
                    ...
                    return_list.append(int(np.floor(earn)))
                    show_dice = True
                # 清除押注
